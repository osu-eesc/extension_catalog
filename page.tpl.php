            ...
            <div id="header-group-inner" class="header-group-inner inner clearfix">
              <div id="header-site-info" class="header-site-info block">
                <div id="header-site-info-inner" class="header-site-info-inner inner clearfix">
                 <div id="logo">
                    <a href="http://extension.oregonstate.edu" title="OSU Extension Service homepage link"><img src="<?php print $base_path . $directory ?>/logo.jpg" alt="OSU Extension Service banner image" height="92" width="960" />
                  </a><!-- /logo -->
